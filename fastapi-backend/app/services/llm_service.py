...
class LLMService:
    ...
    def _validate_question(
        ...
        # --------------------------------------------------------
        # Correct answer must start with A), B), C), or D)
        # --------------------------------------------------------
...
6. Options MUST be labelled A), B), C), and D).
...
12. Correct answers MUST be distributed across A, B, C and D.
13. Do NOT make every correct answer A).
14. Return EXACTLY 5 question objects.
...
The question_text must contain all four options.
...
correct_answer must contain the complete correct option.
...
[
  {{
    ...
    "question_text": "Question here? A) Option A B) Option B C) Option C D) Option D",
